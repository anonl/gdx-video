...
public final class FfMpeg {
     ...
     *
     * @param path The path on which the library can be found. If it is null or an empty string, the default
     *        location will be used. This is usually a SteamJavaNatives folder inside the jar.
     */
